...
contract('CardstackToken', function(accounts) {
  ...
  describe("upgrade contract", function() {
    ...
    it('non initializerAdmin cannot initialize CardstackToken proxy', async function() {
    ...
    it('non initializerAdmin cannot initialize Registry proxy', async function() {
      ...
      await assertRevert(async () => await contract.initialize({ from: proxyAdmin }));
    });
