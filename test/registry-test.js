...
contract('Registry', function(accounts) {
  ...
  describe("register contract", function() {
    ...
    beforeEach(async function() {
      ...
      cst1 = (await proxyContract(CardstackToken, proxyAdmin, registry.address, "cstStorage", "cstLedger", {
        gas: CST_DEPLOY_GAS_LIMIT
      })).contract;
      cst2 = (await proxyContract(CardstackToken, proxyAdmin, registry.address, "cstStorage", "cstLedger", {
        gas: CST_DEPLOY_GAS_LIMIT
      })).contract;
